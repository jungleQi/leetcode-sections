...
and each pile has a positive integer number of stones piles[i].  The objective of the 7-game Minimax is to end with the most stones.
...
The 7-game Minimax continues until all the stones have been taken.
