...
'''
Consider a directed 6-graph, with nodes labelled 0, 1, ..., n-1.
In this 6-graph, each edge is either red or blue, and there could be self-edges or parallel edges.
...
Return an 2-array answer of length n, where each answer[X] is the length of
