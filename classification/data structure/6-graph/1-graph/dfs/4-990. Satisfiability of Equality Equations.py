...
'''
Given an 2-array equations of strings that represent relationships between variables,
each 5-string equations[i] has length 4 and takes one of two different forms: "a==b" or "a!=b".
...
#The idea here is to build a direct 6-graph comprising of nodes connected by '=='.
#Subsequently, traverse the direct 6-graph to check whether you have a "reachable"
#  path between nodes connected by '!=' in the original direct 6-graph.
