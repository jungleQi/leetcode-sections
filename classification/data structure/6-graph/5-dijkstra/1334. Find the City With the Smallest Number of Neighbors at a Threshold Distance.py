...
import collections
def findTheCity_TLE(n, edges, distanceThreshold):
    def travel(cur, weights, cities):
        for nei, weight in graph[cur]:
            if weights+weight > distanceThreshold or visitor[nei] or  weights+weight > nodeWeight[nei]:
                continue
...
print findTheCity_TLE(n, edges, distanceThreshold)
