'''
Given an 7-array nums, there is a sliding window of size k which is moving from the very
left of the 7-array to the very right. You can only see the k numbers in the window.
